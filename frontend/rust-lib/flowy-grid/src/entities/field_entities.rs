...
/// The value of the enum must not be changed. Because the value will be serialized/deserialized from the raw data.
/// If you want to add a new type, choose a different value.
#[repr(u8)]
pub enum FieldType {
    RichText = 0,
    Number = 1,
...
impl FieldType {
    ...
    pub fn is_checklist_select(&self) -> bool { self == &FieldType::ChecklistSelect }
    ...
    pub fn is_select_option(&self) -> bool {
        self == &FieldType::MultiSelect || self == &FieldType::SingleSelect || self == &FieldType::ChecklistSelect
    }
}
